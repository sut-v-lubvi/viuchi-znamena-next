export const dataTests: DataTestType = {
  ...
  tests: [
    {
      id: 1,
      name: "Тест на знание названий знамён",
      questions: [
        {
          id: 1,
          image: "http://",
    ...
    {
      id: 2,
      name: "Тест на знание напева знамени ",
      questions: [
        {
          id: 1,
          image: "http://",
          znamya: "<span class='red'>ãê</span>88J2",
          question: "Как поётся это знамя?",
          correctAnswersIds: [3],
          answers: [
            {
              id: 1,
              label: "Два звука вниз в 1/2",
            },
            {
              id: 2,
              label: "Один звук в 1/2",
            },
            {
              id: 3,
              label: "Один звук в 4/4",
            },
            {
              id: 4,
              label: "Два звука вверх в 1/2",
            },
          ],
        },
        {
          id: 2,
          image: "http://",
          znamya: "<span class='red'>Îá</span>88J:",
          question: "Как поётся это знамя?",
          correctAnswersIds: [1],
          answers: [
            {
              id: 1,
              label: "Три звука вверх в 1/4",
            },
            {
              id: 2,
              label: "Три звука вверх в 1/2",
            },
            {
              id: 3,
              label: "Два звука вниз в 1/2",
        ...
        },
        {
          id: 3,
          image: "http://",
          znamya: "<span class='red'>ã+</span>SJ?{",
          question: "Как поётся это знамя?",
          correctAnswersIds: [3],
          answers: [
            {
              id: 1,
              label: "Один звук в 1/4",
            },
            {
              id: 2,
              label: "Два звука в верх в 4/4",
            },
            {
              id: 3,
              label: "Два звука в верх в 1/2",
            },
            {
              id: 4,
              label: "Три звука вверх в 1/2",
        ...
        },
        {
          id: 4,
          image: "http://",
          znamya: "<span class='red'>ö</span><9",
          question: "Как поётся это знамя?",
          correctAnswersIds: [1],
          answers: [
            {
        ...
        },
        {
          id: 5,
          image: "http://",
          znamya: "<span class='red'>-</span>G",
          question: "Как поётся это знамя?",
          correctAnswersIds: [4],
          answers: [
            {
              id: 1,
              label: "Два звука в верх в 1/4",
            },
            {
              id: 2,
              label: "Один звук в 1/2",
            ...
            {
              id: 3,
              label: "Четыре звука в верх в 1/8",
            },
            {
              id: 4,
              label: "Два звука вверх в 1/2",
        ...
        },
        {
          ...
          answers: [
            {
              id: 1,
              label: "Два звука вверх в 1/4",
            },
            {
              id: 2,
              label: "Два звука вниз в 1/4",
            },
            {
              id: 3,
              label: "Один звук в 4/4",
            ...
            {
              id: 4,
              label: "Четыре звука вверх в 1/4",
            },
          ],
        },
        {
          id: 7,
          image: "http://",
          znamya: "<span class='red'>öê</span>88K2",
          question: "Как поётся это знамя?",
          correctAnswersIds: [4],
          answers: [
            {
